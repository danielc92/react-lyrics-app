            ...
            <div className="notification is-bold" style={{borderRadius:0, backgroundColor:'#e5c02d'}}>
                <div className="columns">
                    ...
                    <div className="column is-half">
                        ...
                        {track.has_lyrics === 1 ? <Link data={track} className="button is-dark is-outlined" to={`/lyrics/track/${track.track_id}`}>View lyrics for this song</Link> : <code style={{backgroundColor:'transparent', color:'black', paddingLeft:0}}>No lyrics exist for this track</code> }
                    </div>
                </div>
